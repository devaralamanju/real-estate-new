...
import './FooterLegalNotice.css'; // Import your CSS file

const FooterLegalNotice = () => {
  return (
  <div className='container'>
  <div className="legal-notice">
      <p>
        <strong>Trulia is a registered Trademark of Zillow, Inc.</strong> Zillow, Inc. holds real estate brokerage licenses in all 50 states and D.C. and Zillow (Canada) Inc. holds real estate brokerage <a href="#">licenses</a>  in multiple provinces.
      </p>
      <div className='textStyle_caption_address'>
        <a href="#">§ 442-H New York Standard Operating Procedures</a><br />
        <a href="#">New York Fair Housing Notice</a><br />
        <a href="#">TREC: Information about brokerage services, Consumer protection notice</a><br />
        California DRE #1522444<br />
        <a href="#"><span>Contact Zillow, Inc Brokerage</span></a>
      </div>
      <div>
          <ul className='textStyle_caption'>
            <li>Zillow Group ® Other Brands:</li>
            <li><a href="#">Zillow</a></li>
            <li><a href="#">StreetEasy</a></li>
            <li><a href="#">HotPads</a></li>
            <li><a href="#">Out East</a></li>
            <li><a href="#">Privacy Portal</a></li>
            <li><a href="#">Cookie Preference</a></li>
            <li><a href="#"><span>Do Not Sell or Share My Personal Information<span><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" role="img" aria-label="" aria-hidden="true" class="w_16 h_16 svg"><path d="m22.756 14.71-5.11-5.775 1.993-1.762 7.725 8.73-7.693 9.005-2.022-1.728 4.963-5.81H5.56v-2.66h17.195z" fill="#007882"></path></svg></span></span></a></li>
          </ul>
        </div>
        <div>
          <ul className='textStyle_caption'>
            <li>Trulia Corporate:</li>
            <li><a href="#">About Zillow Group</a></li>
